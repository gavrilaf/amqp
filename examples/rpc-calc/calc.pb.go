...
type Answer struct {
	...
	Req    *Request `protobuf:"bytes,2,opt,name=Req" json:"Req,omitempty"`
}
...
func (m *Answer) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Req != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintCalc(dAtA, i, uint64(m.Req.Size()))
...
var fileDescriptorCalc = []byte{
	...
	0xce, 0x20, 0x26, 0xff, 0x02, 0x25, 0x47, 0x2e, 0x36, 0xc7, 0xbc, 0xe2, 0xf2, 0xd4, 0x22, 0x21,
	0x31, 0x2e, 0xb6, 0xa0, 0xd4, 0xe2, 0xd2, 0x1c, 0x98, 0x29, 0x50, 0x9e, 0x90, 0x3c, 0x17, 0x73,
	0x50, 0x6a, 0x21, 0xd8, 0x14, 0x6e, 0x23, 0x5e, 0x3d, 0x90, 0x4b, 0xf5, 0xa0, 0xf6, 0x06, 0x81,
	0x64, 0x8c, 0xb4, 0xb9, 0x58, 0x9c, 0x13, 0x73, 0x92, 0x85, 0x94, 0xb9, 0x58, 0x5c, 0xcb, 0x12,
	0x73, 0x84, 0x50, 0xd5, 0x48, 0xf1, 0x40, 0xb8, 0x10, 0x5b, 0x9c, 0x78, 0x4e, 0x3c, 0x92, 0x63,
	0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x24, 0x36, 0xb0, 0x4f, 0x8c, 0x01, 0x01,
	0x00, 0x00, 0xff, 0xff, 0x66, 0x6a, 0x4b, 0xe0, 0x0c, 0x01, 0x00, 0x00,
}
